local theme = {}
theme["Normal"] = {bg = "#F0EBE1", fg = "#252F1E"}
...
theme["NonText"] = {fg = "#C2BAA8"}
theme["EndOfBuffer"] = {link = "NonText"}
theme["Whitespace"] = {link = "NonText"}
theme["Visual"] = {bg = "#DCD4C6"}
theme["Cursor"] = {bg = "#252F1E", fg = "#F5F0E6"}
theme["CursorColumn"] = {bg = "#F0EBE1"}
...
theme["ColorColumn"] = {bg = "#F0EBE1"}
theme["MatchParen"] = {bg = "#D4CAB8", fg = "#252F1E"}
theme["Folded"] = {fg = "#B36B42"}
theme["Ignore"] = {fg = "#C8C0B6"}
...
theme["PmenuThumb"] = {bg = "#252F1E", fg = "#252F1E"}
theme["PmenuSel"] = {bg = "#77824A", fg = "#F5F0E6"}
theme["PmenuExtraSel"] = {link = "PmenuSel"}
theme["PmenuKindSel"] = {link = "PmenuSel"}
theme["StatusLine"] = {bg = "#F0EBE1", bold = true, fg = "#252F1E"}
theme["MsgSeparator"] = {link = "StatusLine"}
theme["StatusLineNC"] = {bg = "#F0EBE1", bold = true, fg = "#736659"}
theme["TabLine"] = {bg = "#E6E0D6", fg = "#6B6461"}
theme["TabLineFill"] = {bg = "#F0EBE1", fg = "#B3854D"}
theme["TabLineSel"] = {bg = "#77824A", bold = true, fg = "#E6E0D6"}
theme["TabLineSelSep"] = {bg = "#F0EBE1", bold = true, fg = "#77824A"}
theme["TabLineSep"] = {bg = "#F0EBE1", fg = "#E6E0D6"}
theme["Directory"] = {link = "Type"}
theme["netrwExe"] = {link = "Changed"}
theme["netrwClassify"] = {link = "Comment"}
theme["SpellBad"] = {fg = "#675642", sp = "#252F1E"}
theme["SpellCap"] = {fg = "#5F865F", sp = "#252F1E"}
theme["SpellLocal"] = {fg = "#BB7844", sp = "#252F1E"}
theme["SpellRare"] = {fg = "#B36B42", sp = "#252F1E"}
...
theme["DiagnosticHint"] = {fg = "#A09890"}
...
theme["DiagnosticInfo"] = {fg = "#9A8030"}
...
theme["LazyButtonActive"] = {bg = "#77824A", fg = "#F5F0E6"}
theme["LazyH1"] = {fg = "#77824A"}
theme["LazyH2"] = {fg = "#77824A"}
theme["LazySpecial"] = {fg = "#9A8030"}
...
theme["MiniTablineModifiedCurrent"] = {bg = "#5F865F", bold = true, fg = "#F0EBE1"}
